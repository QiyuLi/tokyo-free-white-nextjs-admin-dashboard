    ...
    <Container maxWidth="lg" sx={{ textAlign: 'center' }}>
      ...
      >
        <Grid item md={10} lg={8} mx="auto">
          <LabelWrapper color="success">Version {version}</LabelWrapper>
          <TypographyH1 sx={{ mb: 2 }} variant="h1">
            DataBathing Dashboard
          </TypographyH1>
          <TypographyH2
            ...
            fontWeight="normal"
          >
            DataBathing pipeline Dashboard with lots of powerful features.
          </TypographyH2>
          <Button
            component={Link}
          ...
          <Button
            ...
            target="_blank"
            rel="noopener"
            href="https://github.com/databathing"
            size="large"
            variant="text"
          >
            Key Features
